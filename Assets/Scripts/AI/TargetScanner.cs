...
namespace Game.AI {
    ...
    public class TargetScanner {
        ...
        public PlayerController Detect(Transform detector, bool useHeightDifference = true) {
            ...
            if (useHeightDifference && Mathf.Abs(toPlayer.y + heightOffset) > maxHeightDifference) { //if the target is too high or too low no need to try to reach it, just abandon pursuit
                return null;
            }
