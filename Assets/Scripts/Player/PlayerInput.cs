...
namespace Game {
    public class PlayerInput : MonoBehaviour {
        ...
        public bool Attack2 {
            get { return m_Attack2 && !playerControllerInputBlocked && !m_ExternalInputBlocked; }
        }
        ...
        void Update() {
            ...
            if (Bt>0) {
                ...
                m_AttackWaitCoroutine = StartCoroutine(AttackWait(Bt));
            }

            m_Pause = Input.GetButtonDown("Pause");
        }

        IEnumerator AttackWait(int Bt) {
            m_Attack2 = (Bt==2);
            m_Attack = (Bt==1);
